...
<div class=" p-5 bg-body shadow" style="border-radius: 25px">
        ...
        <div class="container">
            <h3 class="card-title fw-bold">Jurusan {{ $data_jurusan ['jurusan'] }}</h3>
            <p class="text-justify text-muted mt-3">{{ $data_jurusan ['desc_jurusan'] }}</p>  
        </div>
        <div class="container mt-5">
            <h3 class="card-title fw-bold">Kenapa Harus Memilih Jurusan {{ $data_jurusan ['nama_jurusan'] }}? </h3>
            <div class="row">
                <div class="col-6 ">
        ...
        <div class="container mt-5">
            <h3 class="card-title fw-bold">Prospek Kerja Jurusan {{ $data_jurusan ['nama_jurusan'] }}</h3>
            <center>
            <div class="row">
